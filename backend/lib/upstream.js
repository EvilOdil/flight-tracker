...
//
// Cache policy: aircraft-by-hex forever, callsign routes 24 h, negative results 6 h.
...
async function getJson(url, timeoutMs = 10000) {
  ...
  try {
    const res = await fetch(url, {
      signal: ctrl.signal,
      headers: { 'accept': 'application/json', 'user-agent': 'flight-tracker-prototype/1.0' },
    });
...
module.exports = { aircraftNearPoint, aircraftByCallsign, lookupAircraft, lookupRoute, KM_PER_NM };
